    ...
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Materials != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Materials'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,ContentPath")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,ContentPath")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
