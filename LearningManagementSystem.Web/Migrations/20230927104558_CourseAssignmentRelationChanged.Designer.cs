...
namespace LearningManagementSystem.Web.Migrations
{
    ...
    [Migration("20230927104558_CourseAssignmentRelationChanged")]
    partial class CourseAssignmentRelationChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningManagementSystem.Web.Models.Material", b =>
                {
                    b.HasOne("LearningManagementSystem.Web.Models.Course", "Course")
                        .WithOne("Material")
                        .HasForeignKey("LearningManagementSystem.Web.Models.Material", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
